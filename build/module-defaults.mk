...
# Uncommenting this to enable serial bitrate for avrdude update
START_AVRDUDE_FLASHER_SERIAL_SPEED=19200
# Uncommenting this to enable serial bitrate for reseting target by avrdude
RESET_AVRDUDE_FLASHER_SERIAL_SPEED=1200
...
CFLAGS += -DSTART_AVRDUDE_FLASHER_SERIAL_SPEED=$(START_AVRDUDE_FLASHER_SERIAL_SPEED)
endif
ifdef RESET_AVRDUDE_FLASHER_SERIAL_SPEED
CFLAGS += -DRESET_AVRDUDE_FLASHER_SERIAL_SPEED=$(RESET_AVRDUDE_FLASHER_SERIAL_SPEED)
endif
